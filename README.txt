...
app, more locations will be included, so be sure to check for updates regularly!

Q. Does the Aussie Go-Road app feature GPS functionality?
A. No, it does not. However, that is a feature that the developer team are planning to add to the
app, so keep an eye out for future versions!
